...
namespace NUS.StudentIntegrity.Migrations
{
    ...
    partial class StudentIntegrityDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NUS.StudentIntegrity.LTICanvas.LtiToolUser", b =>
                {
                    ...
                    b.ToTable("LtiToolUser");
                });

            modelBuilder.Entity("NUS.StudentIntegrity.LTICanvas.Platform", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("NUS.StudentIntegrity.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("NUS.StudentIntegrity.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("NUS.StudentIntegrity.LTICanvas.Platform", b =>
                {
                    b.HasOne("NUS.StudentIntegrity.LTICanvas.LtiToolUser", "User")
                        .WithMany("Platforms")
                        .HasForeignKey("UserId");
