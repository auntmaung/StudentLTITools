...
namespace NUS.StudentIntegrity.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = StudentIntegrityConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(StudentIntegrityDbContext context)
        {
            _context = context;
        }
