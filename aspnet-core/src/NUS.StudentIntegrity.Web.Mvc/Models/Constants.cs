namespace NUS.StudentIntegrity.Web.Models
{
    public static class Constants
    {
        ...
        public static class OidcClaims
        {
            ...
            /// <summary>
            /// Platform url is required to check whether the request is coming from genuine/known platform  
            /// <example>
            /// "https://canvas.instructure.com"
            /// </example>
            /// </summary>

            public const string PlatformId = "iss";
        }
        ...
        public static class ErrorMessage
        {
            ...
            public const string Errors = "Please contact to Administrator!!.";
