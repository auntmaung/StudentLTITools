...
{
    public abstract class StudentIntegrityWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static StudentIntegrityWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(StudentIntegrityWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<StudentIntegrityDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<StudentIntegrityDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<StudentIntegrityDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<StudentIntegrityDbContext, Task<T>> func)
        {
            T result;
